...
CREATE INDEX idx_sessions_form_data_gin ON onboarding_sessions USING gin(form_data);
...
CREATE INDEX idx_submissions_form_data_gin ON onboarding_submissions USING gin(form_data);
...
CREATE INDEX idx_analytics_metadata_gin ON onboarding_analytics USING gin(metadata);
